...
const RegisterTab = () => {
  return (
    <RegisterStack.Navigator
      screenOptions={{ gestureEnabled: false, headerShown: false }}
    >
      <RegisterStack.Screen name="Splash" component={HomeScreen} />
      <RegisterStack.Screen name="Login" component={loginScreen} />
      <RegisterStack.Screen name="Register" component={RegisterScreen} />
      <RegisterStack.Screen name="pin" component={PinScreen} />
      <RegisterStack.Screen name="AppTabs" component={AppTabs} />
    </RegisterStack.Navigator>
  );
};
...
const TransaksiStackScreen = () => {
  return (
    ...
    >
      ...
      />
      <TransaksiStack.Screen
        name="detailJualTransaction"
        component={detailJualTransaction}
      />
      <TransaksiStack.Screen
      ...
      <NavigationContainer>
        ...
        >
          {this.state.tokenUser ? (
            ...
            <AuthStack.Screen name="splash" component={RegisterTab} />
          )}
        </AuthStack.Navigator>
      </NavigationContainer>
    );
