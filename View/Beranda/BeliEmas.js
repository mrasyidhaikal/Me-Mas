...
const harga = [
  { id: "1", key: "100rb", value: 100000 },
  { id: "2", key: "250rb", value: 250000 },
  { id: "3", key: "500rb", value: 500000 },
  { id: "4", key: "750rb", value: 750000 },
  { id: "5", key: "1jt", value: 1000000 },
  { id: "6", key: "Lainnya", value: 0 },
];
const numColumn = 3;
    ...
    return (
      <View>
        ...
        <View style={styles.detailHarga}>
          ...
          >
            ...
            <Text style={styles.text}>
              {this.currencyFormat(hargaBeliToday)}/gr
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <Text style={styles.subText}>
              Per {moment(today).format("DD MMM YYYY")}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.boxHorizontal}>
          <TouchableOpacity
            style={{ borderBottomWidth: 2, borderBottomColor: "#FFC52F" }}
          >
        ...
        <View style={styles.beratEmas}>
          ...
          <Text style={styles.textBerat}>
            {Number(this.state.gramEmasButton.toFixed(4))} gr
          </Text>
        </View>
      </View>
    );
  ...
  MetodePembayaran = () => {
    ...
    if (harga < 100000) {
      ...
      navigation.navigate("metodePembayaran", {
        berat: this.state.gramEmasButton,
        token: token,
        userid: userid,
        hargaBeliToday: hargaBeliToday,
      });
    }
  };
  ...
  _renderItem = ({ item, index }) => {
    return (
      <TouchableOpacity
        ...
        style={
          item.id === this.state.selectedId ? styles.selected : styles.item
        }
      >
